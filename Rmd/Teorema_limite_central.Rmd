...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.6\textwidth]{imagenes_limite_central/Funcion_densidad_probabilidad_n3.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.6\textwidth]{imagenes_limite_central/Funcion_densidad_probabilidad_n10.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.6\textwidth]{imagenes_limite_central/Funcion_densidad_probabilidad_n100.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.6\textwidth]{imagenes_limite_central/Funcion_densidad_probabilidad_n500.png}
