...
![Función de densidad de probabilidad para n = 3](imagenes_limite_central/Funcion_densidad_probabilidad_n3.png){width=400px}
...
![Función de densidad de probabilidad para n = 10](imagenes_limite_central/Funcion_densidad_probabilidad_n10.png){width=400px}

Si tomamos $n = 100$, el gráfico es:

![Función de densidad de probabilidad para n = 100](imagenes_limite_central/Funcion_densidad_probabilidad_n100.png){width=400px}

Y si por ejemplo tomamos $n = 500$, el gráfico de la función de probabilidad es:

![Función de densidad de probabilidad para n = 500](imagenes_limite_central/Funcion_densidad_probabilidad_n500.png){width=400px}
