...
output:
  pdf_document:
    ...
    toc: false # NO escribe el índice
...
Para pasar de yardas a metros, al igual que para pasar de una unidad cualquiera a otra proporcional, usaremos la regla de tres. Para esto, seguiremos los pasos siguientes: