...
\begin{itemize}
    ...
    \item Mido ángulos
    \begin{itemize}
        \item Actividades opcionales 1 página 23; 2 y 3 página 24.
    \end{itemize}
    \item Investigo los ángulos de triángulos y cuadriláteros.
    \begin{itemize}
        \item Actividades opcionales 1, 2 y 3 página 25; 4, 5 y 6 página 26.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item Actividades opcionales 1 página 27; 2 página 28.
    \item Construyo triángulos (explicación).
    \item Actividades opcionales 1 página 29.
...
\begin{itemize}
    ...
    \item Actividades opcionales 1, 2, 3 y 4 página 34.
    \item Resolución de dudas.
\end{itemize}
...
\begin{itemize}
    ...
    \item Utilzo funciones encadenadas (explicación).
    \item Actividad opcional 1 página 37.
    \item Resolución de dudas.
\end{itemize}
...
\begin{itemize}
    ...
    \item Actividades opcionales 1, 2 y 3 página 38; 4, 5 y 6 página 39.
    \item Resolución de dudas.
\end{itemize}
...
\begin{itemize}
    ...
    \item Actividades opcionales 1 y 2 página 41.
    \item Resolución de dudas.
\end{itemize}
